  ...
  return (
    ...
    >
      ...
      <div className="top-bar text-white-50 row gx-0 align-items-center d-none d-lg-flex">
        <div className="col-lg-8 px-5 text-start">
          <div className="d-flex align-items-center flex-wrap gap-3">
            {/* <GoogleTranslate/> */}
            <small>
              <i className="fa fa-map-marker-alt me-2"></i>Lot 5676/M/6, Lusaka
              West, Lusaka, Zambia
            </small>
            <small>
              <i className="fa fa-envelope me-2"></i>
              <a
                href="mailto:info@africaaccesswater.org"
                className="text-white-50"
              >
                info@africaaccesswater.org
              </a>
            </small>
          </div>
        </div>
        <div className="col-lg-4 px-5 text-end">
          ...
          <a
            ...
            href="https://www.facebook.com/share/1Go7XNJriP/?mibextid=wwXIfr"
          >
            <i className="fab fa-facebook-f"></i>
          </a>
          <a
            className="text-white-50 ms-3"
            href="https://x.com/africaaccesswtr"
          >
            <i className="fab fa-twitter"></i>
          </a>
          <a
            className="text-white-50 ms-3"
            href="https://www.linkedin.com/company/africa-access-water/"
          >
            <i className="fab fa-linkedin-in"></i>
          </a>
          <a
            className="text-white-50 ms-3"
            href="https://www.instagram.com/africa_access_water"
          >
            <i className="fab fa-instagram"></i>
          </a>
          <a
            className="text-white-50 ms-3"
            href="https://youtube.com/@africaaccesswater"
          >
            <i className="fab fa-youtube"></i>
          </a>
          <a
            className="text-white-50 ms-3"
            href="https://www.tiktok.com/@africaaccesswater"
          >
            <img
              src="/img/tik-tok.png"
              alt="TikTok"
      ...
      >
        ...
        <div className="me-4">
          <a
            className="btn btn-primary btn-sm py-1 px-3 d-lg-none me-2"
            href="/donate"
            style={{
              whiteSpace: "nowrap",
              display: "inline-flex",
          ...
          >
            ...
            >
              <i
                ...
                style={{ color: "#1a76d1", fontSize: "1rem" }}
              ></i>
            </div>
          </a>
          <button
